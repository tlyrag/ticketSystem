...
const homeLinks = ["administration","inventory","sales","FGoods","fulfillment"]; //,"New-ticket","It-Inventory"
const dashBoardLinks = ["administration","inventory","sales","fgoods","fulfillment"];
